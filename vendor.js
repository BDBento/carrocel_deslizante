...
function O(e) {
  ...
  u.matches(n.focusableElements) &&
    ((S = !1), "SELECT" === u.nodeName && (n.isTouched = !1)),
    s.activeElement &&
...
function A(e) {
  ...
  for (
    ...
    void 0 !== d[n + e]
      ? f >= d[n] && f < d[n + e] && ((h = n), (v = d[n + e] - d[n]))
      : f >= d[n] && ((h = n), (v = d[d.length - 1] - d[d.length - 2]));
  }
  let g = null,
    b = null;
  a.rewind &&
  ...
  if (m > a.longSwipesMs) {
    ...
    "next" === t.swipeDirection &&
      (w >= a.longSwipesRatio
        ? t.slideTo(a.rewind && t.isEnd ? g : h + y)
        : t.slideTo(h)),
    ...
    events: {
      attachEvents: function () {
        ...
        (e.onTouchStart = O.bind(e)),
          ...
          (e.onClick = G.bind(e)),
          (e.onLoad = $.bind(e)),
          _ || (t.addEventListener("touchstart", B), (_ = !0)),
          F(e, "on");
      },
...
class q {
  constructor() {
    ...
    (l.__swiper__ = !0),
      (l.support = x()),
      (l.device = E({ userAgent: t.userAgent })),
      (l.browser = C()),
      (l.eventsListeners = {}),
...
function U(e) {
  ...
  function u() {
    ...
    if (
      ...
      if (
        (s.dynamicBullets &&
          ((n = w(a[0], t.isHorizontal() ? "width" : "height", !0)),
          p.forEach((e) => {
    ...
    p.forEach((e, r) => {
      if (
        ("fraction" === s.type &&
          (e.querySelectorAll(Y(s.currentClass)).forEach((e) => {
    ...
    "fraction" === e.type &&
      ...
      i.forEach((s) => {
        "custom" !== e.type && (s.innerHTML = r || ""),
          "bullets" === e.type &&
            t.pagination.bullets.push(...s.querySelectorAll(Y(e.bulletClass)));
      }),
...
function K(e) {
  ...
  const y = () => {
    ...
    S = (e) => {
      ...
      !Number.isNaN(r) && r > 0 && void 0 === e && ((i = r), (v = r), (g = r)),
        (d = i);
    ...
    T = () => {
      (a.autoplay.running = !0), S(), l("autoplayStart");
    },
    x = () => {
    ...
    E = (e, s) => {
      ...
      if (((a.autoplay.paused = !0), s))
        return f && (d = a.params.autoplay.delay), (f = !1), void i();
  ...
  n("init", () => {
    ...
    n("beforeTransitionStart", (e, t, s) => {
      !a.destroyed &&
        a.autoplay.running &&
        (s || !a.params.autoplay.disableOnInteraction ? E(!0, !0) : x());
    }),
    n("sliderFirstMove", () => {
      !a.destroyed &&
        a.autoplay.running &&
    ...
    Object.assign(a.autoplay, { start: T, stop: x, pause: E, resume: C });
}
